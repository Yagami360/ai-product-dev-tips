# Elixir 言語において Phoenix 版 Ecto の Ecto.Repo を使用して PostgreSQL データベースの CRUD 処理を行う
...
「[Elixir 言語において Ecto の Ecto.Repo を使用して PostgreSQL データベースの CRUD 処理を行う](https://github.com/Yagami360/ai-product-dev-tips/tree/master/ml_ops/92)」では、オリジナルの Ecto を使用して PostgreSQL データベースの CRUD 処理を行う方法を記載したが、ここでは、Phoenix にインストール済みの Ecto の Ecto.Repo を使用して、PostgreSQL データベースの CRUD 処理を行う方法を記載する
...
- https://zenn.dev/koga1020/books/phoenix-guide-ja-1-5/viewer/ecto
