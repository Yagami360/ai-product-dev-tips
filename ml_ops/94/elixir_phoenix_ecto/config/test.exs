...
config :elixir_phoenix_ecto, ElixirPhoenixEctoWeb.Endpoint,
  ...
  secret_key_base: "tqiKApeg/KUOLePWUckEfq4SIZ14D7UDX4QESM4bhhMlJo+WXzULODxPb6do6zgn",
  server: false

# In test we don't send emails.
config :elixir_phoenix_ecto, ElixirPhoenixEcto.Mailer, adapter: Swoosh.Adapters.Test
