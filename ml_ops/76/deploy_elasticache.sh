...
aws ec2 create-subnet \
	...
	--availability-zone ${ZONE} > log/${SUBNET_NAME}.json
...
aws elasticache create-cache-subnet-group \
    ...
    --subnet-ids ${SUBNET_ID} > log/${SUBNET_GROUP_NAME}.json
...
aws elasticache create-cache-parameter-group \
	...
	--description "parameter group for redis4.0" > log/${PARAMETER_GROUP_NAME}.json
