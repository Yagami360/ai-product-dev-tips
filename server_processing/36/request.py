...
if __name__ == "__main__":
    ...
    parser.add_argument('--in_image_dir', type=str, default="in_images", help="入力画像のディレクトリ")
    parser.add_argument('--results_dir', type=str, default="results", help="出力ディレクトリ")
    parser.add_argument('--n_polling', type=int, default=100, help="ポーリング回数")
    ...
    for img_name in tqdm(image_names):
        # リクエスト送信データの設定
        img_pillow = Image.open( os.path.join(args.in_image_dir, img_name) )
    ...
    # job の確認
    #----------------------------------
    for i in tqdm(range(args.n_polling)):
