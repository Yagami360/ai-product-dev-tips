...
config :phoenix_websocket_api,
  ecto_repos: [PhoenixWebsocketApi.Repo],
...
config :phoenix_websocket_api, PhoenixWebsocketApiWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PhoenixWebsocketApiWeb.ErrorHTML, json: PhoenixWebsocketApiWeb.ErrorJSON],
    layout: false
  ],
...
config :phoenix_websocket_api, PhoenixWebsocketApi.Mailer, adapter: Swoosh.Adapters.Local
