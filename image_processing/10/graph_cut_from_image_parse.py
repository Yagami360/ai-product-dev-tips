...
if __name__ == '__main__':
    ...
    image_parse_names = sorted( [f for f in os.listdir(args.in_image_parse_dir) if f.endswith(('.jpg','.jpeg','.png','.bmp'))] )
    ...
    for image_name in tqdm(image_names):
        ...
        #_, contours, hierarchy = cv2.findContours(img_parse_binary, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
