...
|---|---|---|
| `machine-temp` (946) | <a href="images/machine-temp_numeric_llm.png"><img width="240" src="images/machine-temp_numeric_llm.png" /></a> | 検出率=0.50 / 適合率=0.83<br>**F1=0.619**<br><sub>誤検知率=0.06%</sub> |
| `ambient-temp` (606) | <a href="images/ambient-temp_numeric_llm.png"><img width="240" src="images/ambient-temp_numeric_llm.png" /></a> | 検出率=1.00 / 適合率=1.00<br>**F1=1.000**<br><sub>誤検知率=0.00%</sub> |
| `cpu` (672) | <a href="images/cpu_numeric_llm.png"><img width="240" src="images/cpu_numeric_llm.png" /></a> | 検出率=0.50 / 適合率=1.00<br>**F1=0.667**<br><sub>誤検知率=0.00%</sub> |
| `traffic-speed` (564) | <a href="images/traffic-speed_numeric_llm.png"><img width="240" src="images/traffic-speed_numeric_llm.png" /></a> | 検出率=0.75 / 適合率=0.54<br>**F1=0.627**<br><sub>誤検知率=0.51%</sub> |
| `traffic-occupancy` (1190) | <a href="images/traffic-occupancy_numeric_llm.png"><img width="240" src="images/traffic-occupancy_numeric_llm.png" /></a> | 検出率=1.00 / 適合率=0.25<br>**F1=0.400**<br><sub>誤検知率=0.28%</sub> |
| `network` (789) | <a href="images/network_numeric_llm.png"><img width="240" src="images/network_numeric_llm.png" /></a> | 検出率=1.00 / 適合率=0.26<br>**F1=0.400**<br><sub>誤検知率=1.15%</sub> |
