...
def main():
    ...
    ap.add_argument("--save-results", default=None, help="推論結果（センサー窓＋pred/true）を npz に保存（作図は plot_stage2.py が担当）")
    args = ap.parse_args()
    ...
    if args.save_results:
        ...
        print(f"[results] saved: {args.save_results}（plot_stage2.py --from-results で作図）")
