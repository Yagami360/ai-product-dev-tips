...
- LangChain
    ...
    - LangGraph Server / LangGraph Platform
        - [[In-progress] LangGraph Server の概要](https://github.com/Yagami360/ai-product-dev-tips/tree/master/nlp_processing/52)
        ...
        - [LangGraph Server を使用して簡単な A2A 対応 AI Agent を作成する](https://github.com/Yagami360/ai-product-dev-tips/tree/master/nlp_processing/51)
    - LangSmith
        - 実行トレース管理機能
...
- Hugging Face
    ...
    - HuggingFace TRL
        ...
        - [HuggingFace TRL の GKDTrainer を使用して LLM の蒸留モデル（GKD蒸留）を作成する](https://github.com/Yagami360/ai-product-dev-tips/tree/master/nlp_processing/54)
...
- MCP [Model Context Protocol] サーバー
    ...
    - Slack MCP サーバー
    - Notion MCP サーバー
    - [[In-progress] Claude Code CLI MCP サーバーを使用して Cursor から Claude Code を使用する](https://github.com/Yagami360/ai-product-dev-tips/tree/master/nlp_processing/38)
    - Gemini CLI MCP サーバー
    - Postgres SQL MCP サーバー
    - Sentry MCP サーバー
    - AWS MCP サーバー
    - GCP MCP サーバー
...
- センサーデータでのマルチモーダル
    ...
    - [異常検知を公式サポートする時系列基盤モデル（TSPulse）＋ LLM の 2 段構成で、センサーデータの異常検知から自然言語レポート化までを行う](https://github.com/Yagami360/ai-product-dev-tips/tree/master/nlp_processing/71)
